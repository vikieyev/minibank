...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2022 at 02:30 PM
...
('2', '666', 15000, 0, '2022-03-21', 22, '4'),
('4', '666', 0, 15000, '2022-03-21', 23, ''),
('1', '111', 0, 50000, '2022-03-24', 24, '');
...
('123456789101112', 'joni', 'surabaya', '2022-03-17', 'siti', 98767463, '3'),
('2', 'budi', 'gresik', '2022-03-16', 'ibu', 894101, '1'),
('3', 'mita', 'pelem watu palem', '2022-03-08', 'mita', 894103, '1'),
('4', 'yani', 'bekasi', '2022-03-16', 'yani', 888999, '3');
...
--
ALTER TABLE `data_transaksi`
  MODIFY `id_transaksi` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
COMMIT;
